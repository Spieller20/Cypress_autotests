describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]', { timeout: 10000 }).should('be.visible').type('GUF5518@yandex.ru');                   // вводим логин
         ...
         cy.get('.available > button').last().click();   // кликаем Купить у первого доступного аватара
         ...
         cy.get('.style_1_base_button_payment_body > .style_1_base_button_payment', { timeout: 10000 }).click();     // нажимаем кнопку Оплатить
